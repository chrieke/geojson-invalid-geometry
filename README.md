...
[Example](invalid/polygon_unclosed_polygon.geojson)
...
[Spec](https://www.rfc-editor.org/rfc/rfc7946#section-3.1.6), 
[Example](invalid/polygon_has_duplicate_nodes.geojson)
...
[Spec](https://www.rfc-editor.org/rfc/rfc7946#section-3.1.6),
[Example](invalid/polygon_less_than_three_unique_nodes.geojson)
...
order, but not all. 
[Spec](https://www.rfc-editor.org/rfc/rfc7946#section-3.1.6),
[Example 1](invalid/polygon_exterior_ring_not_counterclockwise_winding_order.geojson),
[Example 2](invalid/polygon_inner_ring_not_clockwise_winding_order.geojson)
...
only.
[Example](invalid/fc_polygon_inner_and_exterior_ring_cross.geojson)
...
[Example](invalid/crs_defined.geojson)
...
[Example](valid_but_problematic/polygon_has_holes.geojson)
...
[Example 1](valid_but_problematic/polygon_selfintersection_small.geojson) 
[Example 2](valid_but_problematic/polygon_selfintersection_large.geojson)
...
[Example](valid_but_problematic/multitype_geometry_with_just_one_geometry.geojson)
