...
[Spec](https://www.rfc-editor.org/rfc/rfc7946#section-3.1.6),
[Example](examples/invalid/invalid_less_three_unique_nodes.geojson)
...
[Spec](https://www.rfc-editor.org/rfc/rfc7946#section-3.1.6),
[Example - Exterior](examples/invalid/invalid_exterior_not_ccw.geojson)
...
[Example - Interior](examples/invalid/invalid_interior_not_cw.geojson)
...
only.
[Example](examples/invalid/invalid_inner_and_exterior_ring_intersect.geojson)
...
[Example](examples/invalid/invalid_outside_lat_lon_boundaries.geojson)
...
[Example](examples/invalid/invalid_crs_defined.geojson)
...
[Example](examples/invalid/invalid_zero_length_linestring.geojson)
...
[Example](examples/invalid/invalid_incorrect_geometry_data_type.geojson)
...
[Example](examples/problematic/problematic_holes.geojson)
...
[Example 1 - Small](examples/problematic/problematic_self_intersection_small.geojson) 
[Example 2 - Large](examples/problematic/problematic_self_intersection_large.geojson)
...
[Example](examples/problematic/problematic_excessive_coordinate_precision.geojson)
...
[Example (1223 vertices)](examples/problematic/problematic_excessive_vertices.geojson)
...
[Example 1 - 3D coordinates](examples/problematic/problematic_3d_coordinates.geojson)
...
[Example](examples/problematic/problematic_crosses_antimeridian.geojson)
...
[Example](examples/problematic/problematic_wrong_bbox_coordinate_order.geojson)
...
[Example](examples/problematic/problematic_multitype_geometry_with_just_one_geometry.geojson)
...
[Example](examples/problematic/problematic_feature_null_geometry.geojson)
